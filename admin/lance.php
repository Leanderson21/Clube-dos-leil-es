            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="mydados.php">Dados Financeiros</a></li>
                    </ul>
                </div>  
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <form method="post" action="validar_lance2.php">
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            <th class="product-quantity">Lance</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    <label for="coupon_code">Inserir Lance:</label>
                                                    <input style="width:150px;" type="text" placeholder="R$ Valor do lance"  id="coupon_code" class="input-text input-lance" name="lance" size="100">
