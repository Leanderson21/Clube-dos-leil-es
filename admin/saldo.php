                ...
                <div class="col-md-12">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <form method="post" action="validar_saldo.php" onsubmit="avisoAdicionado()">
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-quantity">Saldo</th>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.html">R$ <?php echo $_SESSION['valor'];?></a> 
                                          
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    <label for="coupon_code">Inserir Saldo:</label>
                                                    <input type="text" placeholder="Digite um valor" value="" id="coupon_code" class="input-text" name="saldo">
